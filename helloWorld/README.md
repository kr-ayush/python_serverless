...
```
Deploying "aws-python-flask-api" to stage "dev" (ap-south-1)
...
endpoints:
  ANY - https://xxxxxxxxxe.execute-api.ap-south-1.amazonaws.com/dev/
...
```
curl https://xxxxxxx.execute-api.ap-south-1.amazonaws.com/dev/
```
...
```
curl https://xxxxxxx.execute-api.ap-south-1.amazonaws.com/dev/hello
```
